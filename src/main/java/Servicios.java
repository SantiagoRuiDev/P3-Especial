...
public class Servicios {
    ...
    // Esta estructura me sirve para guardar todos los paquetes leidos (Sin orden)
    private List<Paquete> paquetes = new ArrayList<>();

    // Metodos publicos utilizados para inicializar constructores de Backtracking y Greedy.
